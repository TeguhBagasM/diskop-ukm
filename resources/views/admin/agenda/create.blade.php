                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('sumber') is-invalid @enderror"
                                        ...
                                        <option value="PPK" {{ old('sumber') == 'PPK' ? 'selected' : '' }}>PPK</option>
                                        <option value="KPK" {{ old('sumber') == 'KPK' ? 'selected' : '' }}>KPK</option>
                                        <option value="BAPPELITBANG" {{ old('sumber') == 'BAPPELITBANG' ? 'selected' : '' }}>BAPPELITBANG</option>
                                    </select>
                                    @error('sumber')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
